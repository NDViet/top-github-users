...
The `number of followers` of users in Canada on `2025/1/21 11:35 PM UTC`. This list contains users from Canada and cities Toronto Montreal Vancouver Calgary Edmonton Quebeccity Winnipeg Saskatoon Regina.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `936 users`  in Canada. You need at least `220 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a target="_blank" href="https://twitter.com/erikerikerik116">erikerikerik116</a></td>
		<td>Canada</td>
		<td>1822</td>
	</tr>
	<tr>

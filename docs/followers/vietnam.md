...
The `number of followers` of users in Vietnam on `2025/3/24 11:21 AM UTC`. This list contains users from Vietnam and cities Hochiminhcity Hanoi Danang Cantho Haiphong.
...
<table>
	...
	<tr>
		<td>943</td>
		<td>
			<a target="_blank" href="https://github.com/ng-hiep">

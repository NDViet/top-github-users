...
The `number of followers` of users in Vietnam on `2024/11/3 4:37 PM UTC`. This list contains users from Vietnam and cities Hochiminhcity Hanoi Danang Cantho Haiphong.
...
<table>
	...
	<tr>
		<td>917</td>
		<td>
			<a target="_blank" href="https://github.com/maichanchinh">

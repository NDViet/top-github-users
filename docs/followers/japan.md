...
The `number of followers` of users in Japan on `2024/10/29 3:33 PM UTC`. This list contains users from Japan and cities Tokyo.
...
<table>
	...
	<tr>
		...
		<td>@vuejs @vuejsjp @matessystem </td>

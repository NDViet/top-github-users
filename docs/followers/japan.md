...
The `number of followers` of users in Japan on `2024/11/2 12:55 AM UTC`. This list contains users from Japan and cities Tokyo.
...
<table>
	...
	<tr>
		...
		<td>@vuejs @vuejsjp @chibivueland @matessystem<br/></td>

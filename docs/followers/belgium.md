...
The `number of followers` of users in Belgium on `2025/3/2 4:33 AM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.

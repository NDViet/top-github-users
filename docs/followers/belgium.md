...
The `number of followers` of users in Belgium on `2025/1/27 5:52 PM UTC`. This list contains users from Belgium and cities Antwerp Brussels Ghent Bruges Leuven Lige Namur.

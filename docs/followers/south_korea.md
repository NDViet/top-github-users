...
The `number of followers` of users in South Korea on `2025/1/24 9:54 PM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.

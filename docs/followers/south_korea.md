...
The `number of followers` of users in South Korea on `2025/3/25 7:57 AM UTC`. This list contains users from South Korea and cities Seoul Busan Incheon Daegu Ulsan Daejeon.

...
The `public contributions` and `private contributions` by users in Ukraine on `2025/2/8 12:25 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

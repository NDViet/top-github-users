...
The `public contributions` and `private contributions` by users in Ukraine on `2024/12/9 1:13 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

...
The `public contributions` and `private contributions` by users in Ukraine on `2025/1/9 8:36 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

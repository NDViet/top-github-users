...
The `public contributions` and `private contributions` by users in Ukraine on `2024/11/19 12:59 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

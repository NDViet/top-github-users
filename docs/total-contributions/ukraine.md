...
The `public contributions` and `private contributions` by users in Ukraine on `2024/12/20 8:24 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

...
The `public contributions` and `private contributions` by users in Ukraine on `2024/11/8 10:42 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

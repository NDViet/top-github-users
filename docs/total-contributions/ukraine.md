...
The `public contributions` and `private contributions` by users in Ukraine on `2025/4/4 7:18 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

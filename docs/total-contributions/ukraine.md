...
The `public contributions` and `private contributions` by users in Ukraine on `2025/3/7 5:36 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

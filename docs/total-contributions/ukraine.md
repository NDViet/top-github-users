...
The `public contributions` and `private contributions` by users in Ukraine on `2025/1/6 5:28 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

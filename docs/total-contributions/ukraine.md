...
The `public contributions` and `private contributions` by users in Ukraine on `2025/3/23 12:39 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

...
The `public contributions` and `private contributions` by users in Ukraine on `2025/2/9 9:34 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

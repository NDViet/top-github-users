...
The `public contributions` and `private contributions` by users in Ukraine on `2025/4/5 7:19 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

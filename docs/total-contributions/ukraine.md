...
The `public contributions` and `private contributions` by users in Ukraine on `2025/1/6 7:11 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

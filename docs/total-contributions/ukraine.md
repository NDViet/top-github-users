...
The `public contributions` and `private contributions` by users in Ukraine on `2024/11/1 6:46 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

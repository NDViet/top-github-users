...
The `public contributions` and `private contributions` by users in Ukraine on `2024/11/21 5:13 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

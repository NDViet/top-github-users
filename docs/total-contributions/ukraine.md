...
The `public contributions` and `private contributions` by users in Ukraine on `2025/2/16 12:03 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

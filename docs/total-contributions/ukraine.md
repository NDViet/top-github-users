...
The `public contributions` and `private contributions` by users in Ukraine on `2025/2/17 7:44 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

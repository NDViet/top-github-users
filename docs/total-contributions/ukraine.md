...
The `public contributions` and `private contributions` by users in Ukraine on `2025/2/22 7:09 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

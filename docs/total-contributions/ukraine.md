...
The `public contributions` and `private contributions` by users in Ukraine on `2024/11/8 1:31 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

...
The `public contributions` and `private contributions` by users in Ukraine on `2025/2/4 1:01 PM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

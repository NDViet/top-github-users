...
The `public contributions` and `private contributions` by users in Ukraine on `2025/4/6 7:54 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

...
The `public contributions` and `private contributions` by users in Ukraine on `2025/4/4 8:02 AM UTC`. This list contains users from Ukraine and cities Kyiv Lviv Kharkiv Odesa.

...
The `public contributions` by users in United States on `2024/11/2 10:30 PM UTC`. This list contains users from United States and cities Newyork Chicago Losangeles Sanfrancisco Austin Seattle.

There are `19 countries` and `130 cities` can be found [here](https://github.com/ePlus-DEV/top-github-users).

There are `831 users`  in United States. You need at least `604 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Github </td>
		<td><a target="_blank" href="https://twitter.com/ashleymcnamara">ashleymcnamara</a></td>
		<td>Seattle</td>
		<td>29</td>
	</tr>
	<tr>
